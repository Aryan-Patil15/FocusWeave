...
const predictBurnoutFlow = ai.defineFlow(
  ...
  async (input): Promise<PredictBurnoutOutput> => {
    ...
    if (!output) {
      return {
        ...
        progressValue: 50,
        message: "Could not analyze burnout risk at this time. Please ensure you are managing your workload effectively.",
        contributingFactors: ["AI analysis unavailable"],
      };
    }
    return output;
  }
